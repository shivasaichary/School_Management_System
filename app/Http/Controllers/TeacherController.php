...
class TeacherController extends Controller
{
    ...
    public function store(StoreTeacherRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('teacher.classes.index')->with('status', 'Teacher created successfully.');
    }
    ...
    public function update(UpdateTeacherRequest $request, Teacher $teacher): RedirectResponse
    {
        ...
        return redirect()->route('teacher.classes.index')->with('status', 'Teacher updated successfully.');
    }
    ...
    public function destroy(Teacher $teacher): RedirectResponse
    {
        ...
        return redirect()->route('teacher.classes.index')->with('status', 'Teacher deleted successfully.');
    }
}
