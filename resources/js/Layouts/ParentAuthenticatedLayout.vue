                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink v-if="('parent.viewAny')" :href="route('parent.studentattendance')"
                                    :active="route().current('parent.studentattendance')">
                                    Your Child Attendance
                                </NavLink>

                                <!-- <NavLink v-if="('parent.viewAny')" :href="route('parent.studentresult')"
                                    :active="route().current('parent.studentresult')">
                                    Your Child Result
                                </NavLink> -->
